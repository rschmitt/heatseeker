...
wget -q https://github.com/rschmitt/heatseeker/releases/download/v1.6.1/heatseeker-v1.6.1-x86_64-pc-windows-msvc.zip || exit /b 1
7z x heatseeker-v1.6.1-x86_64-pc-windows-msvc.zip || exit /b 1
del heatseeker-v1.6.1-x86_64-pc-windows-msvc.zip
